...
class XboxHandler(webapp2.RequestHandler):
    def get(self):
        ...
        comments = comment_model.Comment.query(comment_model.Comment.platform == "xbox").fetch()
        comment_str = ""
    ...
    def post(self):
        ...
        new_comment = comment_model.Comment(author=user.email(), user_comment=r_comment, game_name=r_game)
        new_comment.put()
